...
# sounds
'''
hi_hat = mixer.Sound('beatMaker\sounds\kit2\hihat.wav')
snare = mixer.Sound('beatMaker\sounds\kit2\snare.wav')
kick = mixer.Sound('beatMaker\sounds\kit2\kick.wav')
crash = mixer.Sound('beatMaker\sounds\kit2\crash.wav')
clap = mixer.Sound('beatMaker\sounds\kit2\clap.wav')
tom = mixer.Sound("beatMaker\sounds\kit2\\tom.wav")
'''

hi_hat = mixer.Sound('beatMaker\sounds\hihat.WAV')
...
tom = mixer.Sound("beatMaker\sounds\\tom.WAV")
